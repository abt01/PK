...
class FileHelper {
    ...
    public static function saveFile($file,$subFolder,$filename){

        $result = self::getAndCreatePath($filename,$subFolder);
    ...
    private static function getAndCreatePath($name,$subFolder){
        //$name = date('U').'_'.$name;
        $path = "uploads/files/$subFolder/";
    ...
    public static function deleteFileIfNotDefault($file,$default){
