...
namespace {
    ...
    class Admin extends \App\Http\Middleware\AdminMiddleware {}

    class Contributor extends \App\Http\Middleware\ContributorMiddleware {}

    class Editor extends \App\Http\Middleware\EditorMiddleware {}

    class Author extends \App\Http\Middleware\AuthorMiddleware {}
